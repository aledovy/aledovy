...
Some stuff is also my passion projects or passtimes such as CTF rooms from THM, or PCAP analysis for threats.

## Features ✨
- 🔍 Automated IOC detection
- 🛡️ Phishing, scam, and malware site analysis
- 🔗 Easy integration with security workflows
- 🛠️ Customizable and extensible scripts

## Getting Started 🚦
1. 📥 Clone this repository
2. 📂 Review the available scripts and tools
3. ▶️ Follow the instructions in each script to run analyses
